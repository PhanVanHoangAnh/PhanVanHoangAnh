...
if __name__ == '__main__':
    """
    Phan Van Hoang Anh (PhanVanHoangAnh)
    Template by Andrew Grant (Andrew6rant), 2022-2025
    """
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2000, 7, 15))
